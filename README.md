...
where &psi;<sub>*1*</sub> is the *trigamma* function. The gamma, digamma and trigamma functions are the first in a series of functions generated by taking repeated derivatives over the gamma function. 
